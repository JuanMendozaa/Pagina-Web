...
if (isset($_POST['descuento_venta'])){$descuento_venta=$_POST['descuento_venta'];}
...
if (!empty($id) and !empty($cantidad) and !empty($precio_venta) and !empty($descuento_venta) )
{

$insert_tmp=mysqli_query($con, "INSERT INTO tmp (id_producto,cantidad_tmp,precio_tmp,session_id,descuento_tmp) VALUES ('$id','$cantidad','$precio_venta','$session_id','$descuento_venta')");
...
<tr>
	...
	<th class='text-right'nowrap>PRECIO UNIT.</th>
...
<tr>
	...
	<td class='text-right'>-<?php echo number_format($descuento_total,2);?></td>
	<td></td>
</tr>
